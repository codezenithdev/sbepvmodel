        ...
        const technoeconomicElements = {
            ...
            sourceOperatingLimit: document.getElementById('technoeconomicSourceOperatingLimit'),
            sourceCapacityNote: document.getElementById('technoeconomicSourceCapacityNote'),
            sourceSolectriaCapacity: document.getElementById('technoeconomicSourceSolectriaCapacity'),
            sourceSolectriaEnergy: document.getElementById('technoeconomicSourceSolectriaEnergy'),
            sourceSolarEdgeCapacity: document.getElementById('technoeconomicSourceSolarEdgeCapacity'),
            sourceSolarEdgeEnergy: document.getElementById('technoeconomicSourceSolarEdgeEnergy'),
            sourceEnergyRows: document.getElementById('technoeconomicSourceEnergyRows'),
            guidedPanel: document.getElementById('technoeconomicGuidedPanel'),
            guidedCostYear: document.getElementById('technoeconomicGuidedCostYear'),
            guidedProjectLife: document.getElementById('technoeconomicGuidedProjectLife'),
            guidedDiscount: document.getElementById('technoeconomicGuidedDiscount'),
            guidedDiscountLow: document.getElementById('technoeconomicGuidedDiscountLow'),
            guidedDiscountHigh: document.getElementById('technoeconomicGuidedDiscountHigh'),
            guidedDegradation: document.getElementById('technoeconomicGuidedDegradation'),
            guidedDegradationLow: document.getElementById('technoeconomicGuidedDegradationLow'),
            guidedDegradationHigh: document.getElementById('technoeconomicGuidedDegradationHigh'),
            guidedSolectriaCapex: document.getElementById('technoeconomicGuidedSolectriaCapex'),
            guidedSolectriaCapexLow: document.getElementById('technoeconomicGuidedSolectriaCapexLow'),
            guidedSolectriaCapexHigh: document.getElementById('technoeconomicGuidedSolectriaCapexHigh'),
            guidedSolectriaOm: document.getElementById('technoeconomicGuidedSolectriaOm'),
            guidedSolectriaOmLow: document.getElementById('technoeconomicGuidedSolectriaOmLow'),
            guidedSolectriaOmHigh: document.getElementById('technoeconomicGuidedSolectriaOmHigh'),
            guidedSolarEdgeCapex: document.getElementById('technoeconomicGuidedSolarEdgeCapex'),
            guidedSolarEdgeCapexLow: document.getElementById('technoeconomicGuidedSolarEdgeCapexLow'),
            guidedSolarEdgeCapexHigh: document.getElementById('technoeconomicGuidedSolarEdgeCapexHigh'),
            guidedSolarEdgeOm: document.getElementById('technoeconomicGuidedSolarEdgeOm'),
            guidedSolarEdgeOmLow: document.getElementById('technoeconomicGuidedSolarEdgeOmLow'),
            guidedSolarEdgeOmHigh: document.getElementById('technoeconomicGuidedSolarEdgeOmHigh'),
            guidedSolectriaCapacity: document.getElementById('technoeconomicGuidedSolectriaCapacity'),
            guidedSolectriaEnergy: document.getElementById('technoeconomicGuidedSolectriaEnergy'),
            guidedSolarEdgeCapacity: document.getElementById('technoeconomicGuidedSolarEdgeCapacity'),
            guidedSolarEdgeEnergy: document.getElementById('technoeconomicGuidedSolarEdgeEnergy'),
            guidedSolectriaEstimate: document.getElementById('technoeconomicGuidedSolectriaEstimate'),
            guidedSolectriaLifecycleCost: document.getElementById('technoeconomicGuidedSolectriaLifecycleCost'),
            guidedSolectriaAnnualizedCost: document.getElementById('technoeconomicGuidedSolectriaAnnualizedCost'),
            guidedSolectriaLcoeRange: document.getElementById('technoeconomicGuidedSolectriaLcoeRange'),
            guidedSolarEdgeEstimate: document.getElementById('technoeconomicGuidedSolarEdgeEstimate'),
            guidedSolarEdgeLifecycleCost: document.getElementById('technoeconomicGuidedSolarEdgeLifecycleCost'),
            guidedSolarEdgeAnnualizedCost: document.getElementById('technoeconomicGuidedSolarEdgeAnnualizedCost'),
            guidedSolarEdgeLcoeRange: document.getElementById('technoeconomicGuidedSolarEdgeLcoeRange'),
            guidedAssumptionNote: document.getElementById('technoeconomicGuidedAssumptionNote'),
            guidedAccept: document.getElementById('technoeconomicGuidedAccept'),
            guidedRanges: document.getElementById('technoeconomicGuidedRanges'),
            advancedDetails: document.getElementById('technoeconomicAdvancedDetails'),
            useGuidedButton: document.getElementById('technoeconomicUseGuidedBtn'),
            entryModeRow: document.getElementById('technoeconomicLegacyDraftNotice'),
            entryModeStatus: document.getElementById('technoeconomicEntryModeStatus'),
            submitPanel: document.getElementById('technoeconomicSubmitPanel'),
            ...
            confirmCloseButton: document.getElementById('technoeconomicConfirmCloseBtn'),
            confirmReadiness: document.getElementById('technoeconomicConfirmReadiness'),
            ...
            decision: document.getElementById('technoeconomicDecision'),
            decisionHeading: document.getElementById('technoeconomicDecisionHeading'),
            decisionText: document.getElementById('technoeconomicDecisionText'),
            decisionCaveat: document.getElementById('technoeconomicDecisionCaveat'),
            decisionMetrics: document.getElementById('technoeconomicDecisionMetrics'),
            ...
            standaloneBridge: document.getElementById('technoeconomicCalculationBridge'),
            standaloneBridgeStatus: document.getElementById('technoeconomicStandaloneBridgeStatus'),
            standaloneSourceVerification: document.getElementById('technoeconomicStandaloneSourceVerification'),
            standaloneSolectriaSourceCapacity: document.getElementById('technoeconomicStandaloneSolectriaSourceCapacity'),
            standaloneSolarEdgeSourceCapacity: document.getElementById('technoeconomicStandaloneSolarEdgeSourceCapacity'),
            standaloneSourceYears: document.getElementById('technoeconomicStandaloneSourceYears'),
            standaloneSolectriaSourceEnergy: document.getElementById('technoeconomicStandaloneSolectriaSourceEnergy'),
            standaloneSolarEdgeSourceEnergy: document.getElementById('technoeconomicStandaloneSolarEdgeSourceEnergy'),
            standaloneSolectriaSpecificEnergy: document.getElementById('technoeconomicStandaloneSolectriaSpecificEnergy'),
            standaloneSolarEdgeSpecificEnergy: document.getElementById('technoeconomicStandaloneSolarEdgeSpecificEnergy'),
            standaloneTargetCapacity: document.getElementById('technoeconomicStandaloneTargetCapacity'),
            standaloneSolectriaTargetEnergy: document.getElementById('technoeconomicStandaloneSolectriaTargetEnergy'),
            standaloneSolarEdgeTargetEnergy: document.getElementById('technoeconomicStandaloneSolarEdgeTargetEnergy'),
            standaloneSourceBasis: document.getElementById('technoeconomicStandaloneSourceBasis'),
            standaloneResults: document.getElementById('technoeconomicStandaloneResults'),
            standaloneResultEyebrow: document.getElementById('technoeconomicStandaloneResultEyebrow'),
            standaloneResultsHeading: document.getElementById('technoeconomicStandaloneResultsHeading'),
            standaloneResultStatus: document.getElementById('technoeconomicStandaloneResultStatus'),
            standaloneCdfPlot: document.getElementById('technoeconomicStandaloneCdfPlot'),
            standaloneCdfFallback: document.getElementById('technoeconomicStandaloneCdfFallback'),
            standaloneCdfCaption: document.getElementById('technoeconomicStandaloneCdfCaption'),
            ...
            legacyPercentilePanel: document.getElementById('technoeconomicLegacyPercentilePanel'),
            standalonePercentileBody: document.getElementById('technoeconomicLcoePercentileBody'),
            v6DecisionPanel: document.getElementById('technoeconomicV6DecisionPanel'),
            v6ProbabilitySummary: document.getElementById('technoeconomicV6ProbabilitySummary'),
            v6PercentileBody: document.getElementById('technoeconomicV6PercentileBody'),
            ...
            standaloneEditAssumptionsButton: document.getElementById('technoeconomicEditAssumptionsBtn'),
            standaloneAssumptionsDialog: document.getElementById('technoeconomicAssumptionsDialog'),
            standaloneAssumptionsCloseButton: document.getElementById('technoeconomicAssumptionsCloseBtn'),
            standaloneAssumptionsReviewButton: document.getElementById('technoeconomicAssumptionsReviewBtn'),
            builderSteps: document.getElementById('technoeconomicBuilderSteps'),
            builderStage: document.getElementById('technoeconomicBuilderStage'),
            builderSectionEyebrow: document.getElementById('technoeconomicBuilderSectionEyebrow'),
            builderSectionHeading: document.getElementById('technoeconomicBuilderSectionHeading'),
            builderSectionDescription: document.getElementById('technoeconomicBuilderSectionDescription'),
            builderReview: document.getElementById('technoeconomicBuilderReview'),
            builderReviewSummary: document.getElementById('technoeconomicBuilderReviewSummary'),
            builderTarget: document.getElementById('technoeconomicBuilderTarget'),
            builderLife: document.getElementById('technoeconomicBuilderLife'),
            builderTrials: document.getElementById('technoeconomicBuilderTrials'),
            builderContract: document.getElementById('technoeconomicBuilderContract'),
            builderSource: document.getElementById('technoeconomicBuilderSource'),
            builderCompletion: document.getElementById('technoeconomicBuilderCompletion'),
            builderIssues: document.getElementById('technoeconomicBuilderIssues'),
            builderIssueCount: document.getElementById('technoeconomicBuilderIssueCount'),
            builderFooterRequirements: document.getElementById('technoeconomicBuilderFooterRequirements'),
            builderSaveButton: document.getElementById('technoeconomicBuilderSaveBtn'),
            builderBackButton: document.getElementById('technoeconomicBuilderBackBtn'),
            builderContinueButton: document.getElementById('technoeconomicBuilderContinueBtn'),
            standaloneSubmitButton: document.getElementById('technoeconomicStandaloneSubmitBtn'),
            standaloneFormErrors: document.getElementById('technoeconomicStandaloneFormErrors'),
            standaloneSourceSelect: document.getElementById('technoeconomicStandaloneSourceSelect'),
            standaloneSourceStatusPanel: document.getElementById('technoeconomicStandaloneSourceStatusPanel'),
            standaloneSourceStatus: document.getElementById('technoeconomicStandaloneSourceStatus'),
            standaloneSourceHelp: document.getElementById('technoeconomicStandaloneSourceHelp'),
            standaloneRefreshSourcesButton: document.getElementById('technoeconomicStandaloneRefreshSourcesBtn'),
            standaloneOpenAnnualButton: document.getElementById('technoeconomicStandaloneOpenAnnualBtn'),
            standaloneTargetCapacityInput: document.getElementById('technoeconomicStandaloneTargetCapacityInput'),
            standaloneTargetCapacityUnit: document.getElementById('technoeconomicStandaloneTargetCapacityUnit'),
            standaloneRealizations: document.getElementById('technoeconomicStandaloneRealizations'),
            calculationContract: document.getElementById('technoeconomicCalculationContract'),
            lifecycleInputGroup: document.getElementById('technoeconomicLifecycleInputGroup'),
            useLifecycleTemplateButton: document.getElementById('technoeconomicUseLifecycleTemplateBtn'),
            lifecycleTemplateStatusPanel: document.getElementById('technoeconomicLifecycleTemplateStatusPanel'),
            lifecycleTemplateStatus: document.getElementById('technoeconomicLifecycleTemplateStatus'),
            lifecycleTemplateStatusDetail: document.getElementById('technoeconomicLifecycleTemplateStatusDetail'),
            lifecycleSourceBasis: document.getElementById('technoeconomicLifecycleSourceBasis'),
            lifecycleReliabilityMode: document.getElementById('technoeconomicLifecycleReliabilityMode'),
            lifecycleElectricityValue: document.getElementById('technoeconomicLifecycleElectricityValue'),
            lifecycleElectricityGrowth: document.getElementById('technoeconomicLifecycleElectricityGrowth'),
            lifecycleNpvTolerance: document.getElementById('technoeconomicLifecycleNpvTolerance'),
            lifecycleSolectriaDegradation: document.getElementById('technoeconomicLifecycleSolectriaDegradation'),
            lifecycleSolarEdgeDegradation: document.getElementById('technoeconomicLifecycleSolarEdgeDegradation'),
            lifecycleSolectriaAvailability: document.getElementById('technoeconomicLifecycleSolectriaAvailability'),
            lifecycleSolarEdgeAvailability: document.getElementById('technoeconomicLifecycleSolarEdgeAvailability'),
            lifecycleSolectriaInitialCost: document.getElementById('technoeconomicLifecycleSolectriaInitialCost'),
            lifecycleSolarEdgeInitialCost: document.getElementById('technoeconomicLifecycleSolarEdgeInitialCost'),
            lifecycleInitialCostUnit: document.getElementById('technoeconomicLifecycleInitialCostUnit'),
            lifecycleSolectriaBaseOm: document.getElementById('technoeconomicLifecycleSolectriaBaseOm'),
            lifecycleSolarEdgeBaseOm: document.getElementById('technoeconomicLifecycleSolarEdgeBaseOm'),
            lifecycleBaseOmUnit: document.getElementById('technoeconomicLifecycleBaseOmUnit'),
            lifecycleSolectriaDecommissioning: document.getElementById('technoeconomicLifecycleSolectriaDecommissioning'),
            lifecycleSolarEdgeDecommissioning: document.getElementById('technoeconomicLifecycleSolarEdgeDecommissioning'),
            lifecycleSolectriaSalvage: document.getElementById('technoeconomicLifecycleSolectriaSalvage'),
            lifecycleSolarEdgeSalvage: document.getElementById('technoeconomicLifecycleSolarEdgeSalvage'),
            lifecycleCommonProbability: document.getElementById('technoeconomicLifecycleCommonProbability'),
            lifecycleCommonDowntime: document.getElementById('technoeconomicLifecycleCommonDowntime'),
            lifecycleCommonImpact: document.getElementById('technoeconomicLifecycleCommonImpact'),
            lifecycleCommonCost: document.getElementById('technoeconomicLifecycleCommonCost'),
            lifecycleComponentACount: document.getElementById('technoeconomicLifecycleComponentACount'),
            lifecycleComponentBCount: document.getElementById('technoeconomicLifecycleComponentBCount'),
            lifecycleComponentAImpact: document.getElementById('technoeconomicLifecycleComponentAImpact'),
            lifecycleComponentBImpact: document.getElementById('technoeconomicLifecycleComponentBImpact'),
            lifecycleComponentASpares: document.getElementById('technoeconomicLifecycleComponentASpares'),
            lifecycleComponentBSpares: document.getElementById('technoeconomicLifecycleComponentBSpares'),
            lifecycleScalingNote: document.getElementById('technoeconomicLifecycleScalingNote'),
            lifecycleAdvancedDetails: document.getElementById('technoeconomicLifecycleAdvancedDetails'),
            lifecycleJson: document.getElementById('technoeconomicLifecycleJson'),
            formulaRegistryDetails: document.getElementById('technoeconomicFormulaRegistryDetails'),
            formulaRegistryStatus: document.getElementById('technoeconomicFormulaRegistryStatus'),
            formulaRegistryHash: document.getElementById('technoeconomicFormulaRegistryHash'),
            formulaRegistryBody: document.getElementById('technoeconomicFormulaRegistryBody'),
            legacyFormulaPanel: document.getElementById('technoeconomicLegacyFormulaPanel'),
            legacyDegradationRow: document.getElementById('technoeconomicLegacyDegradationRow'),
            legacyCostGroup: document.getElementById('technoeconomicLegacyCostGroup'),
            standaloneSeed: document.getElementById('technoeconomicStandaloneSeed'),
            standaloneCostYear: document.getElementById('technoeconomicStandaloneCostYear'),
            standaloneProjectLife: document.getElementById('technoeconomicStandaloneProjectLife'),
            standaloneDiscountFamily: document.getElementById('technoeconomicStandaloneDiscountFamily'),
            standaloneDiscountParameters: document.getElementById('technoeconomicStandaloneDiscountParameters'),
            standaloneDegradationFamily: document.getElementById('technoeconomicStandaloneDegradationFamily'),
            standaloneDegradationParameters: document.getElementById('technoeconomicStandaloneDegradationParameters'),
            standaloneSolectriaCostLines: document.getElementById('technoeconomicStandaloneSolectriaCostLines'),
            standaloneSolarEdgeCostLines: document.getElementById('technoeconomicStandaloneSolarEdgeCostLines'),
            standaloneSolectriaReplacementEnabled: document.getElementById('technoeconomicStandaloneSolectriaReplacementEnabled'),
            standaloneSolarEdgeReplacementEnabled: document.getElementById('technoeconomicStandaloneSolarEdgeReplacementEnabled'),
            standaloneSolectriaReplacementFields: document.getElementById('technoeconomicStandaloneSolectriaReplacementFields'),
            standaloneSolarEdgeReplacementFields: document.getElementById('technoeconomicStandaloneSolarEdgeReplacementFields'),
            standaloneAssumptionNote: document.getElementById('technoeconomicStandaloneAssumptionNote'),
            standaloneAccept: document.getElementById('technoeconomicStandaloneAccept'),
        };
