        ...
        const technoeconomicElements = {
            ...
            guidedBaseCapex: document.getElementById('technoeconomicGuidedBaseCapex'),
            guidedBaseCapexLow: document.getElementById('technoeconomicGuidedBaseCapexLow'),
            guidedBaseCapexHigh: document.getElementById('technoeconomicGuidedBaseCapexHigh'),
            guidedBaseOm: document.getElementById('technoeconomicGuidedBaseOm'),
            guidedBaseOmLow: document.getElementById('technoeconomicGuidedBaseOmLow'),
            guidedBaseOmHigh: document.getElementById('technoeconomicGuidedBaseOmHigh'),
            guidedIncrementalCapex: document.getElementById('technoeconomicGuidedIncrementalCapex'),
            guidedIncrementalCapexLow: document.getElementById('technoeconomicGuidedIncrementalCapexLow'),
            guidedIncrementalCapexHigh: document.getElementById('technoeconomicGuidedIncrementalCapexHigh'),
            guidedIncrementalOm: document.getElementById('technoeconomicGuidedIncrementalOm'),
            guidedIncrementalOmLow: document.getElementById('technoeconomicGuidedIncrementalOmLow'),
            guidedIncrementalOmHigh: document.getElementById('technoeconomicGuidedIncrementalOmHigh'),
            ...
            applyReferenceButton: document.getElementById('technoeconomicApplyReferenceBtn'),
            referenceStatus: document.getElementById('technoeconomicReferenceStatus'),
